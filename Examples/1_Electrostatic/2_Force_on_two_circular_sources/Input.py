...
def Geometry(figSize = "Default", showPlot = False):
    ...
    # Domain 1
    initialDomains.append(Ellipse(diameter, # Width
                                diameter, # Height
                                [-0.5, 0], # Position
...
def Sources(colorbarPosition = "right", figSize = "Default", showPlot = False):
    ...
    initialDomains[1].source = 1/(3.141592653*radius**2)
    initialDomains[2].source = -1/(3.141592653*radius**2)
    initialDomains[3].source = 0
